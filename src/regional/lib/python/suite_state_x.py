...
THIS IS A COPY OF THE BUILT-IN suite_state TRIGGER FUNCTION.
...
def suite_state_x(suite, task, point, offset=None, status='succeeded',
    ...
    # Any stdout from an external trigger function will show up as stderr
    # in the suite log, in debug mode (stdout is used to communicate the
    # serialized return value from the subprocess that executes the function).
    print "HELLO!"
